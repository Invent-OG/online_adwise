    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div data-aos="fade-right" className="grid lg:grid-cols-12 gap-8 mb-32">
          ...
          >
            <div className="p-8 rounded-[32px] bg-neutral-900 border border-white/10 shadow-lg h-full">
              ...
              <div className="space-y-4">
                {challenges.map((item, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-4 p-4 rounded-2xl bg-black border border-white/5 hover:border-yellow-600/30 transition-all duration-300 group"
                  >
          ...
          <div className="lg:col-span-8">
            <div className="grid sm:grid-cols-2 gap-6 h-full">
              ...
              {/* Result Card 2 */}
              <div className="p-8 rounded-[32px] bg-neutral-900 border border-white/10 shadow-lg hover:-translate-y-1 transition-transform duration-300">
        ...
        <div
          data-aos="fade-up"
          ref={timelineRef}
          className="relative pt-4 pb-12"
        >
          {/* Section Header */}
          <div className="text-center mb-16">
            <h3 className="text-2xl font-bold text-white">The NAREN Method™</h3>
            <p className="text-neutral-400">
              Our proprietary execution framework
            </p>
          </div>
          ...
          <div className="md:hidden absolute top-[180px] left-[23px] w-0.5 h-[calc(100%-180px)] bg-slate-200 overflow-hidden">
            <div
              ref={verticalLineRef}
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-0 md:mb-6 pl-16 md:pl-0 order-2 md:order-1 flex-1">
                    <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl md:rounded-3xl bg-neutral-900 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-white/10 flex items-center justify-center mb-4 md:mb-6 relative transition-all duration-300 group-hover:-translate-y-2 group-hover:shadow-yellow-600/20 group-hover:border-yellow-600 mx-auto md:mx-auto ml-0">
                      <span className="absolute -top-3 -right-3 w-6 h-6 md:w-8 md:h-8 rounded-full bg-yellow-600 text-white flex items-center justify-center text-[10px] md:text-xs font-bold border-4 border-black">
                        {step.id}
                      </span>
                      <Icon
                  ...
                  <div
                    ...
                    className="absolute md:hidden left-[16px] md:static md:left-auto order-1 md:order-2 w-4 h-4 rounded-full border-[3px] shadow-sm z-20 mt-[2.5rem] md:mt-0 md:mb-6 bg-neutral-900 border-white/20"
                  />
